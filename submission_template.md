**Student**: \[Abdelrahman Ahmed, #201747738\] **Submission date**: \[DD/MM/YYYY\] **Academic Year**: 2025-26
...
> \[when I have a new portfolio deadline, I want to add it to a list, so that I can keep track of my submissions without forgetting anything\]

**How Task 1 tests this**: \[it directly tests the user's ability to input and save a new item\]

------------------------------------------------------------------------

### [Evaluation Tasks (4-5 tasks)](#evaluation-tasks-4-5-tasks){.header}

#### [Task 1 (T1): \[add a task\]](#task-1-t1-task-name){.header}

-   **Scenario**: \[comp2870 worksheet due on friday\]
-   **Action**: \[add a new task "submit worksheet 5 by friday\]
-   **Success**: \[task appears in the "your tasks" list\]
-   **Target time**: \[7s\]
-   **Linked to**: \[Week 6 Job Story #1\]

#### [Task 2 (T2): \[filter tasks]](#task-2-t2-task-name){.header}

-   **Scenario**: \[you left everything till the end of semseter, now you have a bunch of tasks and need to find a certain task\]
-   **Action**: \[type "shell assignment" into the filter box\]
-   **Success**: \[only "shell assignment" shows in the "your tasks" list\]
-   **Target time**: \[8s\]
-   **Linked to**: \[Week 6 Job Story #1\]
...
-   "Do you consent to participate?" \[said yes\]

**Recorded consent timestamp**: \[e.g., "P1 consented 30/11/2025 10:05"\]
